...
const incidentsArray = [
  {
    ...
    description: 'Excessive littering observed in Green Park near the main entrance.',
...
},
{
    ...
    description: 'Loud parties at residential area causing disturbances at night.',
...
},
{
    ...
    description: 'Several street lights are out on 3rd Street, causing poor visibility at night.',
...
},
{
    ...
    description: 'Groups of intoxicated individuals causing disturbances at City Square.',
    coordinate: {lat: 51.507351, long: -0.127758},
      ...
      >
        <View style={styles.bottomSHeader}>
          ...
          <TouchableOpacity
            onPress={() => {
              setIsSheetVisible(false);
              navigation.navigate(routes.NEARBYACTIVEISSUES, { incidents: incidentsArray });
            }}
          >
