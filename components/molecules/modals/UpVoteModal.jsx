...
const UpVoteModal = (props) => {
  return (
    <View style={styles.confirmationCard}>
      ...
      <Text style={styles.genuineText}>
        We trust that your up-vote is genuine and based on the incident you
        reviewed. Please refrain from misusing this community application.
      </Text>

      <View style={styles.confirmationButtons}>
        <Button1 style={styles.no}>No</Button1>
        <Button1 style={styles.yes} textStyle={styles.buttonTextBlack}>
          Confirm
        </Button1>
      </View>
    </View>
