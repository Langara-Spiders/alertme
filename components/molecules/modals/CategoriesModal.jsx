...
const CategoriesModal = ({ onSelectCategory }) => {
    const categories = [
        ...
        { name: 'Heavy Machinery', image: require('../../../assets/images/User.png') },
        ...
        { name: 'Electrical Fault', image: require('../../../assets/images/User.png') },
        { name: 'Chemical Spill', image: require('../../../assets/images/User.png') }
    ];
            ...
            >
                {categories.map((category, index) => (
                    <View key={index} style={styles.buttonContainer}>
                        ...
                        >
                            <Image source={category.image} style={styles.image} alt="category image"/>
                        </TouchableOpacity>
